...
The statistical test in this paper is a generalized linear mixed model. The response variable is percentage of coral bleached at a site and the predictor variables are temperature metrics, latitude, depth, and coral diversity. 
